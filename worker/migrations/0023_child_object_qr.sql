-- Child-object QR scope: one active scan link per registered object_id.
-- See docs/ROOT_CARD_AND_CHILD_OBJECTS.md
...
CREATE INDEX idx_qr_credentials_object_id ON qr_credentials (object_id)
