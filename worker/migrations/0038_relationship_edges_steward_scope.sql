-- Relationship edge IDs are stable within a steward's graph, not global.
-- Public/deterministic IDs must not let one steward block another steward's write.

CREATE TABLE relationship_edges_v0038 (
  ...
  PRIMARY KEY (steward_profile_id, edge_id)
);

INSERT INTO relationship_edges_v0038 (
...
ALTER TABLE relationship_edges_v0038 RENAME TO relationship_edges;
