...
export interface PrintifyTemplateEnv {
  ...
  PERSONALIZE_GLITCH_HOODIE_PRINTIFY_PRODUCT_ID?: string;
  PERSONALIZE_GLITCH_HOODIE_PRINTIFY_VARIANT_ID?: string;
  PERSONALIZE_GLITCH_HOODIE_PRINTIFY_SHIPPING_METHOD?: string;
  PERSONALIZE_GLITCH_HOODIE_PRINTIFY_BLUEPRINT_ID?: string;
  PERSONALIZE_GLITCH_HOODIE_PRINTIFY_PRINT_PROVIDER_ID?: string;
  PERSONALIZE_GLITCH_HOODIE_PRINTIFY_PLACEHOLDER?: string;
  PERSONALIZE_GLITCH_HOODIE_PRINTIFY_IMAGE_X?: string;
  PERSONALIZE_GLITCH_HOODIE_PRINTIFY_IMAGE_Y?: string;
  PERSONALIZE_GLITCH_HOODIE_PRINTIFY_IMAGE_SCALE?: string;
  PERSONALIZE_GLITCH_HOODIE_PRINTIFY_IMAGE_ANGLE?: string;
...
export function resolvePrintifyLineItem(
  ...
  if (templateId === GLITCH_HOODIE_TEMPLATE_ID) {
    return resolveFromEnv(
      env,
      "PERSONALIZE_GLITCH_HOODIE_PRINTIFY_PRODUCT_ID",
      "PERSONALIZE_GLITCH_HOODIE_PRINTIFY_VARIANT_ID",
      "PERSONALIZE_GLITCH_HOODIE_PRINTIFY_SHIPPING_METHOD"
    );
  }
