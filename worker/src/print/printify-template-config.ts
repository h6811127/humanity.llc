...
export interface PrintifyTemplateEnv {
  ...
  PERSONALIZE_FOUNDING_PURSE_PRINTIFY_PRODUCT_ID?: string;
  PERSONALIZE_FOUNDING_PURSE_PRINTIFY_VARIANT_ID?: string;
  PERSONALIZE_FOUNDING_PURSE_PRINTIFY_SHIPPING_METHOD?: string;
  PERSONALIZE_FOUNDING_PURSE_PRINTIFY_BLUEPRINT_ID?: string;
  PERSONALIZE_FOUNDING_PURSE_PRINTIFY_PRINT_PROVIDER_ID?: string;
  PERSONALIZE_FOUNDING_PURSE_PRINTIFY_PLACEHOLDER?: string;
  PERSONALIZE_FOUNDING_PURSE_PRINTIFY_IMAGE_X?: string;
  PERSONALIZE_FOUNDING_PURSE_PRINTIFY_IMAGE_Y?: string;
  PERSONALIZE_FOUNDING_PURSE_PRINTIFY_IMAGE_SCALE?: string;
  PERSONALIZE_FOUNDING_PURSE_PRINTIFY_IMAGE_ANGLE?: string;
...
export function resolvePrintifyLineItem(
  ...
  if (templateId === FOUNDING_PURSE_TEMPLATE_ID) {
    return resolveFromEnv(
      env,
      "PERSONALIZE_FOUNDING_PURSE_PRINTIFY_PRODUCT_ID",
      "PERSONALIZE_FOUNDING_PURSE_PRINTIFY_VARIANT_ID",
      "PERSONALIZE_FOUNDING_PURSE_PRINTIFY_SHIPPING_METHOD"
    );
  }
