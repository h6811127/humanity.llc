...
| A-018 | Resolver cache policy can balance fast scans with revocation freshness. | Engineering/Security | High | Technically reasonable with short TTL for revoked/suspended status. Must test CDN/browser behavior. | Tighten cache and accept slower scans. |
