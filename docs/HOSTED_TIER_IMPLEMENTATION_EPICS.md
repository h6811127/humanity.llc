...
| 4b | Deploy + verify production | **✅ Production smoke/verify passed** (`health`, plans, capabilities, entitlements 401); local `--deploy` requires `CLOUDFLARE_API_TOKEN`; optional full steward-ops verify still needs `OPERATOR_AUDIT_TOKEN` |
