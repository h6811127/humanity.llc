...
| E6.2 | Daily alert | **Partial staging** — snapshot emits alert candidates for auto-poll soft/hard caps, push delivery caps, and in-isolate push p95/p99 latency; external alerting + Cloudflare dashboard pending |
...
| 2026-05-27 | **E6.2 latency:** in-memory push p95/p99 SLA samples added to ops snapshot |
