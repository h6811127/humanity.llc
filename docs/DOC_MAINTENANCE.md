...
| **Feature specs** | Named `*_MVP.md`, `DEVICE_*.md`, `LIVE_OBJECT_ARCHITECTURE.md`, `STEWARD_UX_PRESENTATION_TARGET.md`, etc. | Product policy and implementation detail for one concern |
