...
**Share network checks across tabs** (resolver snapshot sync; default on) — [`DEVICE_TAB_RESOLVER_SYNC.md`](DEVICE_TAB_RESOLVER_SYNC.md); toggle on homepage **Shortcuts & settings**.
