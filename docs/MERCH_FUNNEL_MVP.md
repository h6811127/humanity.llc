...
| **5** | **Large-wallet shell performance** — bound `hc_wallet_network_cache`, avoid full-wallet parse on hub/inbox hot paths | Engineering debt | In progress — first slice bounds `hc_wallet_network_cache`; hot-path wallet parse audit remains |
