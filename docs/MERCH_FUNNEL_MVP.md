...
| **4** | **AI P1 product decision** — keep / rename / deterministic-only / remove scan reader (no new L3 user features until Phase A) | Product | **☑ Done (2026-09-08) — deterministic-only** · Workers AI dropped; opt-in restatement kept [`AI_L3_EXPLAIN_SNAPSHOT.md`](AI_L3_EXPLAIN_SNAPSHOT.md) |
