...
| **3** | **Hosted steward production rollout** — `hosted:rollout:step*` through step 6 (secrets, flag, CF dashboard, regression) | Ops | **In progress** — step 4b tooling + CI ✅ · **production smoke/verify ✅** · **next:** step 5a CF dashboard pin · step 5b CI · step 6 regression |
