...
| **5** | **Large-wallet shell performance** — bound `hc_wallet_network_cache`, avoid full-wallet parse on hub/inbox hot paths | Engineering debt | **✅** — S6–S11 + `hc_wallet_summary` (`DEVICE_OS_REQUEST_BUDGET.md`: cache, hot paths, hub/wallet DOM caps, presence debounce) |
