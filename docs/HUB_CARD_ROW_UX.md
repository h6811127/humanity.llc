...
### Phase 5 - Action hierarchy (partial)

- [x] **Prove live** stays brand red (`.hub-card-control--primary`) when inbox pending.
- [ ] **Open controls** (`.hub-use-keys`) demoted to popover control surface — optional follow-up; still red on main May 2026. See [`HUB_SHEET_VISUAL_REFRESH.md`](HUB_SHEET_VISUAL_REFRESH.md) § Red budget.
