...
|--------|---------------|---------------------|------------------|
| **Steward scan handoff / PWA vouch** | [`STEWARD_SCAN_HANDOFF_AND_PWA_VOUCH.md`](STEWARD_SCAN_HANDOFF_AND_PWA_VOUCH.md) | **S1–S5 shipped** | `scan-pwa-camera-handoff-core.mjs`, `device-hub-qr-scanner*`, `vouch-issue.mjs` |
