...
- Manual iPhone/Android camera scan of a printed QR — **runbook shipped (2026-05-28):** [`M7_LIVE_CONTROL_PRINTED_QA_RUNBOOK.md`](M7_LIVE_CONTROL_PRINTED_QA_RUNBOOK.md); ≥3 phones; camera-app entry + full live proof loop on print; desk gate: `npm run worker:test:live-control-printed-qa`.
