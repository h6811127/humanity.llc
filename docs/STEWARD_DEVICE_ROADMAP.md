...
| **PWA install** | Phases 1–9 + **P1–P4 scan handoff** (same-tab standalone, return banner, install deferral) | Manual P1-PWA-N on device | [`PWA_INSTALL.md`](PWA_INSTALL.md) · [`PWA_STANDALONE_EXTERNAL_NAVIGATION.md`](PWA_STANDALONE_EXTERNAL_NAVIGATION.md) · **H-006** · **H-007 closed** |
