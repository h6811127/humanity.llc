...
| **PWA install** | Phases 1–9 + P1/P2 scan handoff (return banner on scan) | Optional P4 install deferral | [`PWA_INSTALL.md`](PWA_INSTALL.md) · [`PWA_STANDALONE_EXTERNAL_NAVIGATION.md`](PWA_STANDALONE_EXTERNAL_NAVIGATION.md) · **H-006** · **H-007 closed** |
