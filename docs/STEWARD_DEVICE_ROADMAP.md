...
| **PWA install** | Phases 1–9 shipped (resume + PTR + stale shell nudge + affordances); **P1 scan handoff** | P2 return banner on scan (optional) | [`PWA_INSTALL.md`](PWA_INSTALL.md) · [`PWA_STANDALONE_EXTERNAL_NAVIGATION.md`](PWA_STANDALONE_EXTERNAL_NAVIGATION.md) · **H-006** · **H-007 closed** |
