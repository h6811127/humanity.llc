...
**Engineering status:** Shell perf S6/S8/S9 shipped (2026-05-28); worker budget caps and multi-tab presence coalescing remain — see [`DEVICE_OS_REQUEST_BUDGET.md`](DEVICE_OS_REQUEST_BUDGET.md) § Open issues.
