...
| **P2** | Heavy module graph and wallet hydration on every shell page | Lazy-load inbox sheet / notifications; status/count hot paths read `hc_wallet_summary`; lazy row hydration remains | **Partial 2026-05-28** — inbox + browser notification loaders shipped; shell/scan status counts avoid full wallet row hydration |
...
| 2026-05-28 | **Large-wallet partial:** added `hc_wallet_summary` for shell/scan status hot paths; lazy hub/inbox row hydration remains |
