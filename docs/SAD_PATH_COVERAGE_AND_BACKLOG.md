...
| Hub card disappeared Safari (RC-1–RC-16) | **Closed — monitoring** — `hub-card-disappeared:verify` · P2-RC-MON E2E | [`HUB_CARD_SAFARI_RELIABILITY.md`](HUB_CARD_SAFARI_RELIABILITY.md) |
