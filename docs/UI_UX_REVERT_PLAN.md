...
| **8** | **Verify** — `npm run worker:test`, `npm run e2e -- e2e/device-status-dot.spec.ts e2e/device-inbox.spec.ts e2e/safari-shell-scroll.spec.ts` | — | Pending |
...
- [ ] No Cloudflare rate-limit page under normal multi-tab use
