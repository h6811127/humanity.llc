...
See [`EPHEMERAL_STATE_AND_MERCH.md`](EPHEMERAL_STATE_AND_MERCH.md) for Tier 1 funnel step **WEAR**, accessibility without LLMs, and open Priority 4 (P1 keep / deterministic-only / remove).
