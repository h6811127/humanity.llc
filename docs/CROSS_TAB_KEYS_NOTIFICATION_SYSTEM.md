...
**Quiet rehydrate (D10):** When [`QUIET_TAB_REHYDRATE.md`](QUIET_TAB_REHYDRATE.md) Tier 1–3 applies, shell bootstrap copies wallet control into this tab **before** presence runs and demotes cross-tab chrome for the rehydrated profile — notices remain for unsaved-only-other-tab and unlock-pending.
