...
- [~] Steward review **step 2:** dismiss notes in D1 API shipped (`POST/DELETE …/vouch-audit-flags/dismiss`); operator UI prototype shipped at `/operator/vouch-audit.html`, integration into steward workflow pending.
