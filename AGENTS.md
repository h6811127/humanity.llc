...
- **Steward scan handoff / PWA vouch (S1–S6):** `docs/STEWARD_SCAN_HANDOFF_AND_PWA_VOUCH.md` — camera→Safari vs PWA keys; S1 clipboard handoff · S2 hub recovery import · S3 in-app hub QR scanner · S4 product guidance · S5 `?hc_steward=1` · **S6 `/v/{code}` interstitial**. Tests: `npm run worker:test:steward-scan-handoff` · manual **P1-PWA-V** in `docs/DEVICE_OS_QA.md`.
