...
- **Hub card disappeared (closed — monitoring):** `docs/HUB_CARD_DISAPPEARED_SAFARI_INVESTIGATION.md` — RC-1–RC-16 shipped; steward diagnostic via Web Inspector snippet or hub **Copy build info** with `hc_debug=1`. Engineering gate: `npm run hub-card-disappeared:verify` · manual **P2-RC-MON** in `docs/DEVICE_OS_QA.md`.
