...
- **Safari keys WebKit E2E (P2-3):** `e2e/safari-keys-persistence.spec.ts` — matrix S2 scan rehydrate · S3 wallet mismatch. Run: `npm run e2e:safari-keys-persistence` (after `e2e:install`).
