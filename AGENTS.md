...
- **Merch funnel MVP**: Scan → profile → QR customizer → Shopify → Printify — `docs/MERCH_FUNNEL_MVP.md`. Tier 0: `/shop/` · Tier 1 customizer: `/shop/customize/` · artifact intent API. Physical print QA: `docs/MERCH_PHYSICAL_QA_RUNBOOK.md` · `npm run worker:test:merch-print-qa`.
