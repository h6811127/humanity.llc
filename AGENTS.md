...
- **Steward scan handoff / PWA vouch (S1–S7):** `docs/STEWARD_SCAN_HANDOFF_AND_PWA_VOUCH.md` — S1–S6 handoff paths · **S7 dual-QR on `/created/`** (`steward-dual-qr-core.mjs`). Tests: `npm run worker:test:steward-scan-handoff` · manual **P1-PWA-V** in `docs/DEVICE_OS_QA.md`.
