...
- **Merch funnel MVP**: Scan → profile → QR customizer → Shopify → Printify — `docs/MERCH_FUNNEL_MVP.md`. Shop hub: `/shop/` · Tier 0 founding: `/shop/founding/` · Tier 1 customizer: `/shop/customize/` · artifact intent API.
