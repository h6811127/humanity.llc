...
- **AI L3 P2 (draft manifesto)**: Steward authoring assistant on `/created/` — `docs/AI_L3_DRAFT_MANIFESTO.md`. Worker: `POST /.well-known/hc/v1/ai/draft-manifesto`. Client: `site/js/created-ai-draft.mjs`. Tests: `npm run worker:test:ai-draft`.
