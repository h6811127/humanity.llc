...
- **Steward scan handoff / PWA vouch (S1–S3):** `docs/STEWARD_SCAN_HANDOFF_AND_PWA_VOUCH.md` — camera→Safari vs PWA keys; S1 clipboard handoff · S2 hub recovery import · **S3 in-app hub QR scanner** (`device-hub-qr-scanner.mjs`). Tests: `npm run worker:test:steward-scan-handoff` · manual **P1-PWA-V** in `docs/DEVICE_OS_QA.md`.
